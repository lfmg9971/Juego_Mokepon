...
ratigueta.ataques.push(...RATIGUETA_ATAQUES)

ratiguetaEnemigo.ataques.push(...RATIGUETA_ATAQUES)
            ...
            .then(function ({enemigos}) {
                ...
                mokeponesEnemigos = enemigos.map(function(enemigo){
                    ...
                    if (mokeponNombre === "Hipodoge") {
                        ...
                        mokeponEnemigo = new Mokepon ("Ratigueta", "./assets/mokepons_mokepon_ratigueya_attack.webp", 5, "./assets/ratigueya.png", enemigo.id)
                    }
